...
namespace Levels
{
     ...
     public class BossRoomStrategy : IRoomStrategy
     {
         ...
         /// Class constructor.
         /// </summary>
         public BossRoomStrategy(GenericFactory genericFactory, ItemFactory itemFactory,
             ...
             // : base(genericFactory, enemyFactory, itemFactory, interactableObjectFactory, randomGenerator, bossFactory)
         {
         ...
         {
             var newListOfEntities = new List<IEntity>();
...
//         private void GenerateAndPlaceMinions(HashSet<Tuple<int, int>> availableTiles, List<IEntity> entities,
...
//         private IEntity CreateMinions(HashSet<Tuple<int, int>> availableTiles)
//         {
...
//         private void GenerateAndPlaceBoss(HashSet<Tuple<int, int>> availableTiles, List<IEntity> entities,
...
//         private void PlaceEntityWithDimension(IEntity entity, HashSet<Tuple<int, int>> availableTiles,
...
//                 var position = new Vector2D(randomTile.Item1, randomTile.Item2);
...
//         private Vector2D GetTileCenterPosition(List<Tuple<int, int>> tiles) 
//         {
//             double totalX = 0;
//             double totalY = 0;
//
...
//         private IEntity CreateBoss(HashSet<Tuple<int, int>> freeTiles)
//         {
